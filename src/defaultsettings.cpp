...
void set_default_settings()
{
	...
	settings->setDefault("serverlist_url", "https://eduquest.vip/serverlist.json");
...
#undef USEKEY2
    ...
    settings->setDefault("contentdb_url", "https://content.eduquest.vip");
	...
	settings->setDefault("secure.trusted_mods", "eduquest");
	settings->setDefault("secure.http_mods", "eduquest");
